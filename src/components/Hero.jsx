...
const Hero = (props) => {
  return (
    ...
    <div className={props.navbarOpen ? "transition-all duration-300 relative w-[100vw] bg-[#001229] pointer-events-none opacity-20"
                                     : "transition-all duration-300 relative w-[100vw] bg-[#001229]"}>
        ...
        <div className="flex flex-row items-center w-[200vw] h-[calc(100vh-5rem)]">
            ...
            <div className={props.buttonClicked ? "relative translate-x-[-100vw] transition-all duration-500 h-[calc(100vh-5rem)] w-[100vw] flex flex-col justify-center items-center text-white" 
                ...
                <div className="h-[calc(100vh-5rem)] absolute flex flex-col items-center justify-center gap-2 dl:gap-[15rem] tl:flex-row">
            ...
            <div className={props.buttonClicked ? "relative translate-x-[-100vw] transition-all duration-500 h-[calc(100vh-5rem)] w-[100vw] flex flex-col justify-center items-center text-white" 
                                                : "relative translate-x-[0vw]    transition-all duration-500 h-[calc(100vh-5rem)] w-[100vw] flex flex-col justify-center items-center text-white"}>
                <div className="h-[calc(100vh-5rem)] absolute flex flex-col items-center ps:justify-center gap-2 dl:gap-[15rem] tl:flex-row">
