...
const Hero = (props) => {
  return (
    <div className="bg-[#000e21] w-[200vw] py-[7rem] ps:py-[29vh] tp:py-[11vh] tl:py-[20vh] dl:py-[22vh] border-0 border-red-500 flex flex-row">
            ...
            <div className={props.buttonClicked ? "translate-x-[-100vw] transition-all duration-500 w-[100vw] flex flex-row justify-center items-center align-center text-white" 
                ...
                <div className="flex flex-col tl:flex-row  items-center gap-2 dl:gap-[15rem]">
                    <img className="animate-appearFromLeft w-[30rem] ps:w-[15rem] tp:w-[35rem] tl:w-[35rem] dl:w-[45rem]" src="./src/assets/more-music-animate.svg"/>
