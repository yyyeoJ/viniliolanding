...
const Hero = (props) => {
  ...
  return (
    <div className="overflow-hidden text-white h-[calc(100vh-5rem)] bg-[#001229] relative px-5 xl:px-10 justify-start xl:justify-center items-center align-center">
      ...
      <div className={props.buttonClicked ? "absolute w-[100vw] left-0 top-[-2rem] h-[calc(100vh-5rem)]  px-5 transition-all duration-500 translate-x-[-100vw] flex flex-col xl:flex-row items-center align-center justify-center xl:gap-40" 
                                  : "absolute w-[100vw] left-0 top-[-2rem] h-[calc(100vh-5rem)]  px-5 transition-all duration-500 translate-x-[0vw] flex flex-col xl:flex-row items-center align-center justify-center xl:gap-40"
      }>
        <img className={props.navbarOpen ? "transition-opacity duration-500  opacity-0 xl:opacity-100 animate-appearFromLeft w-[18rem] xl:w-[45rem] xl:mt-[5rem] pointer-events-none xl:pb-0 pb-0" : "transition-none animate-appearFromLeft xl:pb-0 pb-6 w-[18rem] xl:w-[45rem] xl:mt-[5rem]"} src="./src/assets/more-music-animate.svg" />
        <div className=" animate-appearFromRight flex flex-col justify-center align-center items-center xl:items-end text-right h-[45vw] xl:pt-24">
          ...
          <button onClick={()=>{props.setButtonClicked(!props.buttonClicked)}} className="xl:w-[15rem] w-[18rem] p-[1rem] xl:h-[4rem] xl:p-2 cursor-pointer bg-white hover:bg-gray-400 traduration-500 transition-all  text-black rounded-lg px-5 text-xl font-bold tracking-wide">What is Vinilio?</button>
        </div>
      </div> 
    ...
    <div className={props.buttonClicked ? "absolute w-[100vw] left-0 top-[-2rem] h-[calc(100vh-5rem)]  px-5 transition-all duration-500 translate-x-0 flex flex-col xl:flex-row items-center align-center justify-center xl:gap-40" 
      ...
      <img className={props.navbarOpen ? "transition-opacity duration-500  opacity-0 xl:opacity-100 animate-appearFromLeft w-[18rem] xl:w-[45rem] xl:mt-[5rem] pointer-events-none xl:pb-0 pb-0" : "transition-none animate-appearFromLeft xl:pb-0 pb-6 w-[18rem] xl:w-[45rem] xl:mt-[5rem]"} src="./src/assets/headphone-animate.svg" />
      <div className=" animate-appearFromRight flex flex-col justify-center align-center items-center xl:items-end text-right h-[45vw] xl:pt-24">
