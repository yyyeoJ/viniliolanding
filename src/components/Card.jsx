...
const Card = (props) => {
  return (
    ...
    <div ref={props.refprop} className="snap-center ps:h-[33rem] ps:w-[15rem] p:w-[19rem] p:h-[34rem] tp:w-[27rem] tp:h-[50rem] tl:h-[43rem]  ds:h-[38rem] ds:w-[24rem] dl:h-[55rem] dl:w-[37rem] dxl:w-[30rem] will-change-transform  flex flex-col items-center  bg-gradient-to-b from-[#1d3c68] to-[#102139]   rounded-[1.5rem]">
