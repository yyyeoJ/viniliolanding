...
const Navbar = (props) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={props.navbarOpen ? "z-40 bg-[#001229] xl:bg-gradient-to-b xl:from-[#00204a] xl:to-[#001229] h-20 text-white pt-3 p-2 flex flex-row relative items-center align-center transition-all duration-300" 
                                       : "z-40 bg-gradient-to-b from-[#00204a] h-20 text-white pt-3 p-2 flex flex-row relative items-center align-center transition-all duration-300"}>
       
       <div onClick={()=>{props.setButtonClicked(false)}} className={props.navbarOpen ? "pointer-events-none flex flex-row items-center cursor-pointer animate-appearFromUp text-[#006FFF]" 
        ...
        <button className="z-30 animate-appearFromUp cursor-pointer flex flex-col xl:hidden absolute right-5 text-2xl text-white"
          ...
          <BsDashLg  className={props.navbarOpen ? "relative top-6 rotate-45 transition-all duration-500" 
          ...
          <BsDashLg className={props.navbarOpen ? "relative bottom-6 rotate-[-45deg] transition-all duration-500" 
                                                : "relative bottom-4 transition-all duration-500"}/>
        </button>     
      </div>

      <div className={props.navbarOpen ?  "z-50 absolute top-[4rem] w-full gap-5 flex flex-col px-5 xl:hidden bg-[#001229] h-[calc(100vh-5rem)] text-white pointer-events-auto opacity-100 transition-all duration-[600ms]" 
                                       : "z-50 absolute top-[4rem] w-full gap-5 flex flex-col px-5 xl:hidden bg-[#001229] h-[calc(100vh-5rem)] text-white pointer-events-none opacity-0 transition-all duration-[600ms]"}>

        <div className={props.navbarOpen ? "pt-10 transition-all duration-[200ms] text-2xl font-bold tracking-wide" 
                                         : "pt-10 translate-y-[-2rem] transition-all duration-[200ms] text-2xl font-bold tracking-wide"}>About</div>
        <div className={props.navbarOpen ? "transition-all duration-[400ms] ml-2 translate-y-0" 
                                         : "transition-all duration-[400ms] translate-y-[-4rem] ml-2"}>Features</div>
        <div className={props.navbarOpen ? "transition-all duration-[400ms] ml-2" 
                                         : "transition-all duration-[400ms] translate-y-[-6rem] ml-2"}>Pricing</div>
        <div className={props.navbarOpen ? "transition-all duration-[500ms] ml-2" 
                                         : "transition-all duration-[400ms] translate-y-[-8rem] ml-2"}>Testimonials</div>

        <div className={props.navbarOpen ? "pt-2 transition-all duration-[600ms] text-2xl font-bold tracking-wide" 
                                         : "pt-10 translate-y-[-13rem] transition-all duration-[200ms] text-2xl font-bold tracking-wide"}>Support</div>
        <div className={props.navbarOpen ? "transition-all duration-[700ms] ml-2 translate-y-0" 
                                         : "transition-all duration-[400ms] translate-y-[-15rem] ml-2"}>FAQ</div>
        <div className={props.navbarOpen ? "transition-all duration-[800ms] ml-2 translate-y-0" 
                                         : "transition-all duration-[400ms] translate-y-[-17rem] ml-2"}>Supported devices</div>
        <div className={props.navbarOpen ? "transition-all duration-[900ms] ml-2 translate-y-0" 
                                         : "transition-all duration-[400ms] translate-y-[-19rem] ml-2"}>Contact us</div>
        ...
        <div className={props.navbarOpen ? "transition-all duration-[1000ms] bg-white flex justify-center items-center h-14 text-black rounded-lg text-xl font-bold tracking-wide" 
                                         : "transition-all duration-[500ms] translate-y-[-20rem] bg-white flex justify-center items-center h-14 text-black rounded-lg text-xl font-bold tracking-wide"}>Start free trial</div>
