        ...
        const sponsorObserver = new IntersectionObserver(
          entries=>{
            ...
            if(entry.isIntersecting){
              setTimeout(() => {
                reactRef.current.className =   "opacity-100 transition-all duration-[600ms] flex flex-row justify-center align-center items-center  ps:w-[2rem] p:w-[3.5rem] tp:w-[6rem] tl:w-[8rem] ds:w-[8rem] dl:w-[12rem] "
              }, 10);
              setTimeout(() => {
              ...
              setTimeout(() => {
                storysetRef.current.className ="opacity-100 transition-all duration-[600ms] flex flex-row justify-center align-center items-center  ps:w-[2rem] p:w-[3.5rem] tp:w-[6rem] tl:w-[8rem] ds:w-[8rem] dl:w-[12rem] "
              }, 200);
              setTimeout(() => {
                shazamRef.current.className =  "opacity-100 transition-all duration-[600ms] flex flex-row justify-center align-center items-center  ps:w-[2rem] p:w-[3.5rem] tp:w-[6rem] tl:w-[8rem] ds:w-[8rem] dl:w-[12rem] "
              }, 300);
              setTimeout(() => {
                geniusRef.current.className =  "opacity-100 transition-all duration-[600ms] flex flex-row justify-center align-center items-center  ps:w-[2rem] p:w-[3.5rem] tp:w-[6rem] tl:w-[8rem] ds:w-[8rem] dl:w-[12rem] "
              }, 400);
