...
const Features = () => {
    ...
    setTimeout(()=>{
      const leftObserver = new IntersectionObserver(
        entries=>{
          ...
          leftRef.current.className = "opacity-100 hidden tp:block transition-all duration-300 relative left-[-5rem]"
          featureRef.current.className = "animate-appearFromDown w-[100vw] flex flex-col opacity-100 transition-all duration-1000"

          }else{
            leftRef.current.className = "opacity-100 hidden tp:block transition-all duration-300 relative left-[0rem]"
        ...
        const rightObserver = new IntersectionObserver(
          entries=>{
            const entry = entries[0]
            if(entry.isIntersecting){
              rightRef.current.className = "hidden tp:block opacity-100 relative right-[-2rem] pl-[0.8rem] transition-all duration-300"
            }else{
              rightRef.current.className = "hidden tp:block opacity-100 relative right-[1rem] pl-[0.8rem] transition-all duration-300"
            }
          },
          {threshold: 0.69})
          ...
          const observer1 = new IntersectionObserver(
            entries=>{
              const entry = entries[0]
              if(entry.isIntersecting){
              dot1.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
              dot2.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              dot3.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
            ...
            const observer2 = new IntersectionObserver(
              entries=>{
                const entry = entries[0]
                if(entry.isIntersecting){
                dot1.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                dot2.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
                dot3.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
              ...
              const observer3 = new IntersectionObserver(
                entries=>{
                  ...
                  dot1.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  dot2.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  dot3.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
                  dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                ...
                const observer4 = new IntersectionObserver(
                  entries=>{
                    ...
                    dot2.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                    dot3.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                    dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
                    dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                    dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                    dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                  ...
                  const observer5 = new IntersectionObserver(
                    entries=>{
                      ...
                      dot3.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                      dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                      dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
                      dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                      dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                    ...
                    const observer6 = new IntersectionObserver(
                      entries=>{
                        ...
                        dot4.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                        dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                        dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
                        dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                      ...
                      const observer7 = new IntersectionObserver(
                        entries=>{
                          ...
                          dot5.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                          dot6.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2"
                          dot7.current.className = "w-[0.8rem] h-[0.8rem] rounded-full border-2 bg-white"
  ...
  return (
    ...
    <>
          ...
          {/*left arrow */}
          <div ref={leftRef} onClick={()=>{slideLeft(500)}} className="opacity-0 hidden tp:block transition-all duration-300"><BsChevronLeft  size={40} className="text-white z-10"/></div>
          {/* slider  */}
          <div id="slider" className=" snap-x snap-mandatory flex flex-row scroll-smooth items-center relative w-[95vw] ps:h-[35rem] tp:h-[50rem] tl:h-[40rem] ds:h-[35rem] dl:h-[55rem] overflow-x-visible overflow-y-hidden">
            {/* Cards container */}
            <div className="flex flex-row gap-[1rem] absolute left-[50vw] pr-[5rem]">
          ...
          <div ref={rightRef} onClick={()=>{slideRight(500)}} className="hidden tp:block opacity-100 relative right-[1rem] pl-[0.8rem] transition-all duration-300"><BsChevronRight  size={40} className="text-white-500 z-10"/></div>
          </div>

          {/* dots container */}
          <div className="w-[100vw] h-[5rem] ds:hidden flex items-center align-center justify-center gap-[0.5rem]">
            <div ref={dot1} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot2} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot3} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot4} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot5} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot6} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
            <div ref={dot7} className="w-[0.8rem] h-[0.8rem] rounded-full border-2"></div>
          </div>
