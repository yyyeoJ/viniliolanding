          ...
          entries=>{
            ...
            if(entry.isIntersecting){
              setTimeout(() => {
                ...
                price1desktop.current.className = "hover:scale-[110%] ps:hidden tl:block transition-all duration-500 ps:w-[17rem] p:w-[20rem] p:h-[2rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]  relative tl:left-[0rem] ds:left-[2rem] dl:left-[0rem] dxl:left-[10rem]"
                price3desktop.current.className = "hover:scale-[110%] ps:hidden tl:block transition-all duration-500 ps:w-[17rem] p:w-[20rem] p:h-[2rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#d0ff00] relative  tl:left-[0rem] ds:left-[-2rem] dl:left-[0rem] dxl:left-[-10rem]"
              }, 500);
            ...
            const price2Observer = new IntersectionObserver(
              ...
              const price3Observer = new IntersectionObserver(
                entries=>{
                  ...
                  if(entry.isIntersecting){
                    setTimeout(() => {
                      price3mobile.current.className = "translate-x-[0rem] ps:block tl:hidden transition-all duration-500 ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#d0ff00] relative"
  ...
  return (
      ...
      <div className="flex-col ">
        ...
        <div ref={container} className="transition-all duration-[700ms] opacity-100 tl:opacity-0 w-[100vw] h-full tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] pb-[0rem] flex flex-col tl:flex-row justify-center items-center gap-[1rem] tl:gap-0  ds:gap-[1rem] relative">
            ...
            {/* Price1 desktop */}
            <div ref={price1desktop} className="hover:scale-[110%] ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]   relative tl:left-[15rem] ds:left-[20rem] dl:left-[35rem] dxl:left-[50rem]">
            ...
            {/* Price2 desktop */}
            <div className="hover:scale-[110%] ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#006FFF] to-[#00bbff] z-20 relative">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
            ...
            {/* Price3 desktop */}
            <div ref={price3desktop} className="hover:scale-[110%] ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#d0ff00] relative tl:left-[-15rem] ds:left-[-20rem] dl:left-[-35rem] dxl:left-[-50rem]">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
