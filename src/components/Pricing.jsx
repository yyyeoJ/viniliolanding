        ...
        const priceObserver = new IntersectionObserver(
          entries=>{
            ...
            if(entry.isIntersecting){
              setTimeout(() => {
                ...
                price1desktop.current.className = "ps:hidden tl:block transition-all duration-500 ps:w-[17rem] p:w-[20rem] p:h-[2rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]  relative tl:left-[0rem] ds:left-[2rem] dl:left-[0rem] dxl:left-[10rem]"
                price3desktop.current.className = "ps:hidden tl:block transition-all duration-500 ps:w-[17rem] p:w-[20rem] p:h-[2rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#00ffc3] relative  tl:left-[0rem] ds:left-[-2rem] dl:left-[0rem] dxl:left-[-10rem]"
              }, 500);
          ...
          const price1Observer = new IntersectionObserver(
            entries=>{
              ...
              if(entry.isIntersecting){
                setTimeout(() => {
                  price1mobile.current.className = "translate-x-[0rem] tp:translate-x-[0]  ps:block tl:hidden transition-all duration-500 ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]  relative"
            ...
            const price2Observer = new IntersectionObserver(
              entries=>{
                ...
                if(entry.isIntersecting){
                  setTimeout(() => {
                    ...
                    price2mobile.current.className = "translate-x-[0]  ps:block tl:hidden transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.5rem] rounded-[1.6rem] bg-gradient-to-r from-[#006FFF] to-[#00bbff] z-20 relative"
              ...
              const price3Observer = new IntersectionObserver(
                entries=>{
                  ...
                  if(entry.isIntersecting){
                    setTimeout(() => {
                      price3mobile.current.className = "translate-x-[0rem] ps:block tl:hidden transition-all duration-500 ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#00ffc3] relative"
  ...
  return (
      ...
      <div className="flex-col ">
        ...
        <div ref={container} className="transition-all duration-[700ms] opacity-100 tl:opacity-0 w-[100vw] h-full tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] pb-[0rem] flex flex-col tl:flex-row justify-center items-center gap-[1rem] tl:gap-0  ds:gap-[1rem] relative">
            ...
            {/* Price1 desktop */}
            <div ref={price1desktop} className="ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]   relative tl:left-[15rem] ds:left-[20rem] dl:left-[35rem] dxl:left-[50rem]">
            ...
            {/* Price1 mobile */}
            <div ref={price1mobile} className="ps:block tl:hidden opacity-0 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#ff006f] to-[#ff9000]   relative ps:translate-x-[50vw]">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
                <div className='pb-[1rem]  w-full ps:text-4xl p:text-5xl tp:text-[4rem] tl:text-[2.2rem] ds:text-[3rem] dl:text-[4rem] pt-[1rem] font-bold bg-gradient-to-r from-[#ff006f] to-[#ff9000] text-transparent bg-clip-text'>Title</div>
                <div className='ps:pb-[2rem] tp:pb-[5rem] tl:pb-[1rem] dl:pb-[5rem] w-full ps:text-xl p:text-2xl tp:text-[2rem] tl:text-[1.3rem] ds:text-[1.5rem] dl:text-[2.5rem] font-semibold bg-gradient-to-r from-[#ff006f] to-[#ff9000] text-transparent bg-clip-text'>Subtitle goes here</div>
                <div className=" p-[0.55rem]  ps:mb-[5rem] tp:mb-[6rem] tl:mb-[6rem] ds:mb-[1rem] dl:mb-[6rem] w-full bg-gradient bg-gradient-to-b from-[#1d3c68] to-[#102139] rounded-[1rem]">
            ...
            {/* Price2 desktop */}
            <div className="ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#006FFF] to-[#00bbff] z-20 relative">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
            ...
            {/* Price2 mobile */}
            <div ref={price2mobile} className="ps:block tl:hidden opacity-0 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#006FFF] to-[#00bbff] z-20 relative ps:translate-x-[-50vw]">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
                <div className='pb-[1rem]  w-full ps:text-4xl p:text-5xl tp:text-[4rem] tl:text-[2.2rem] ds:text-[3rem] dl:text-[4rem] pt-[1rem] font-bold bg-gradient-to-r from-[#006FFF] to-[#00bbff] text-transparent bg-clip-text'>Title</div>
                <div className='ps:pb-[2rem] tp:pb-[5rem] tl:pb-[1rem] dl:pb-[5rem] w-full ps:text-xl p:text-2xl tp:text-[2rem] tl:text-[1.3rem] ds:text-[1.5rem] dl:text-[2.5rem]  font-semibold bg-gradient-to-r from-[#006FFF] to-[#00bbff] text-transparent bg-clip-text'>Subtitle goes here</div>
                <div className="p-[0.5rem]  ps:mb-[5rem] tp:mb-[6rem] tl:mb-[6rem] ds:mb-[1rem] dl:mb-[6rem] w-full bg-gradient bg-gradient-to-b from-[#1d3c68] to-[#102139] rounded-[1rem]">
            ...
            {/* Price3 desktop */}
            <div ref={price3desktop} className="ps:hidden tl:block opacity-100 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#00ffc3] relative tl:left-[-15rem] ds:left-[-20rem] dl:left-[-35rem] dxl:left-[-50rem]">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
            ...
            {/* Price3 mobile */}
            <div ref={price3mobile} className="ps:block tl:hidden opacity-0 transition-all duration-[700ms] ps:w-[17rem] p:w-[20rem] ps:h-[35rem] tp:w-[35rem] tl:w-[20rem] ds:w-[24rem] dl:w-[35rem] tp:h-[45rem] tl:h-[35rem] ds:h-[30rem] dl:h-[50rem] mx-auto p-[0.55rem] rounded-[1.6rem] bg-gradient-to-r from-[#6fff00] to-[#00ffc3] relative ps:translate-x-[50vw]">
              <div className="h-full relative  flex flex-col items-start px-[2rem] pt-[1rem]  bg-gradient-to-b from-[#122743] to-[#0b182a] rounded-[1rem]">
                <div className='pb-[1rem]  w-full ps:text-4xl p:text-5xl tp:text-[4rem] tl:text-[2.2rem] ds:text-[3rem] dl:text-[4rem] pt-[1rem] font-bold bg-gradient-to-r from-[#6fff00] to-[#00ffc3] text-transparent bg-clip-text'>Title</div>
                <div className='ps:pb-[2rem] tp:pb-[5rem] tl:pb-[1rem] dl:pb-[5rem] w-full ps:text-xl p:text-2xl tp:text-[2rem] tl:text-[1.3rem] ds:text-[1.5rem] dl:text-[2.5rem]  font-semibold bg-gradient-to-r from-[#6fff00] to-[#00ffc3] text-transparent bg-clip-text'>Subtitle goes here</div>
                <div className=" p-[0.55rem]  ps:mb-[3rem] tp:mb-[6rem] tl:mb-[6rem] ds:mb-[1rem] dl:mb-[6rem] w-full bg-gradient bg-gradient-to-b from-[#1d3c68] to-[#102139] rounded-[1rem]">
