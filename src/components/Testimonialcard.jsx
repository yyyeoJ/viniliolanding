...
const Testimonialcard = (props) => {
  return (
    <div className="relative ps:w-[95vw] ps:h-[30rem] tp:w-[45rem] tl:w-[40rem] dl:w-[60rem] tp:h-[25rem] tl:h-[20rem] dl:h-[30rem]  bg-gradient-to-b from-[#00204a] to-[#001229] flex flex-col items-center align-center justify-center gap-[1rem]">
        ...
        <img src="./public/assets/quote.png" className="ps:h-[3rem] ps:w-[3rem] tp:h-[3rem] dl:h-[5rem] tp:w-[3rem] dl:w-[5rem] absolute left-[1rem] top-[1rem]"  />
        <img src="./public/assets/quote.png" className="ps:h-[3rem] ps:w-[3rem] tp:h-[3rem] dl:h-[5rem] tp:w-[3rem] dl:w-[5rem] absolute right-[1rem] rotate-180 bottom-[1rem]"  />
