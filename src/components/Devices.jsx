        ...
        <div ref={container} className="flex flex-col tl:flex-row items-center align-center justify-center relative">
            ...
            <div ref={text} className="opacity-0 items-center relative tl:top-[10rem] flex flex-col justify-center p:w-[20rem] tp:w-[35rem] tl:w-[35rem] dl:w-[55rem]">
                ...
                <div className="flex gap-[1rem] tp:gap-[2rem] relative justify-center tl:justify-start px-[2rem]">
                    <img ref={windows} className="transition-all duration-[300ms] relative ps:h-[2rem] p:h-[3rem] tp:h-[5rem] dl:h-[7rem] opacity-0" src="/assets/os/windows.png" />
                    <img ref={linux}   className="transition-all duration-[300ms] relative ps:h-[2rem] p:h-[3rem] tp:h-[5rem] dl:h-[7rem] opacity-0" src="/assets/os/linux.png" />
                    <img ref={apple}   className="transition-all duration-[300ms] relative ps:h-[2rem] p:h-[3rem] tp:h-[5rem] dl:h-[7rem] opacity-0" src="/assets/os/apple.png" />
                    <img ref={android} className="transition-all duration-[300ms] relative ps:h-[2rem] p:h-[3rem] tp:h-[5rem] dl:h-[7rem] opacity-0" src="/assets/os/android.png" />
                </div>
            </div>
        </div>
