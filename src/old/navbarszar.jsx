...
const Navbar = (props) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={props.navbarOpen ? "fixed z-40  bg-[#001229]                                  text-white h-20 pt-3 p-2 flex flex-row w-full  items-center align-center transition-all duration-300" 
                                       : "fixed z-40 bg-gradient-to-b from-[#00204a] to-[#001229] text-white h-20 pt-3 p-2 flex flex-row w-full  items-center align-center transition-all duration-300"}>
      ...
      <div className={props.navbarOpen ? "border-white border-2 absolute z-10 top-[4rem] w-full gap-5 flex flex-col px-5 ds:hidden bg-[#001229] h-full tl:overflow-y-visible text-white pointer-events-auto opacity-100 transition-all duration-[600ms]" 
                                       : " border-white border-2 absolute z-10 top-[4rem] w-full gap-5 flex flex-col px-5 ds:hidden bg-[#001229] h-[0rem]  tl:overflow-y-hidden text-white pointer-events-none opacity-0   transition-all duration-[600ms]"}>
